<?php
	...
	else
	{
		...
		$klasa = filter_input(INPUT_POST, 'klasa');
		
		$userQuery = $db->prepare("INSERT INTO uczniowie (id, imie, nazwisko, login, haslo, klasa) 
		                           VALUES(null,:imie, :nazwisko,:login,:haslo, :klasa) ");
